...
class FriendAdapter(val context: Context?, val posts: List<FriendList>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        view.ivFriendAdd.setImageResource(R.drawable.tool_check)
            ...
            try{
                ...
                when (userData.followFlag) {
                    ...
                    1 -> {
                        ...
                        viewId!!.ivFriendAdd.setImageResource(R.drawable.tool_add)
                    }
                }
            }
            catch(e : Exception){
